-- PostgreSQL Script convertido do MySQL Workbench
-- Modelo: New Model - Adaptado para PostgreSQL 

-- Criar o schema (equivalente ao banco de dados)
